...
module.PERSON_TEST_UINT64_FIELD = protobuf.FieldDescriptor()
module.PERSON_TEST_FLOAT_FIELD = protobuf.FieldDescriptor()
module.PERSON_TEST_DOUBLE_FIELD = protobuf.FieldDescriptor()
module.PERSON_LAST_UPDATED_FIELD = protobuf.FieldDescriptor()
...
module.PERSON_PHONENUMBER_NUMBER_FIELD.label = 1
...
module.PERSON_PHONENUMBER_TYPE_FIELD.has_default_value = false
module.PERSON_PHONENUMBER_TYPE_FIELD.default_value = nil
...
module.PERSON_TEST_UINT64_FIELD.name = 'test_uint64'
module.PERSON_TEST_UINT64_FIELD.full_name = '.tutorial.Person.test_uint64'
module.PERSON_TEST_UINT64_FIELD.number = 5
module.PERSON_TEST_UINT64_FIELD.index = 4
module.PERSON_TEST_UINT64_FIELD.label = 3
module.PERSON_TEST_UINT64_FIELD.has_default_value = false
module.PERSON_TEST_UINT64_FIELD.default_value = {}
module.PERSON_TEST_UINT64_FIELD.type = 4
module.PERSON_TEST_UINT64_FIELD.cpp_type = 4

module.PERSON_TEST_FLOAT_FIELD.name = 'test_float'
module.PERSON_TEST_FLOAT_FIELD.full_name = '.tutorial.Person.test_float'
module.PERSON_TEST_FLOAT_FIELD.number = 6
module.PERSON_TEST_FLOAT_FIELD.index = 5
module.PERSON_TEST_FLOAT_FIELD.label = 3
module.PERSON_TEST_FLOAT_FIELD.has_default_value = false
module.PERSON_TEST_FLOAT_FIELD.default_value = {}
module.PERSON_TEST_FLOAT_FIELD.type = 2
module.PERSON_TEST_FLOAT_FIELD.cpp_type = 6

module.PERSON_TEST_DOUBLE_FIELD.name = 'test_double'
module.PERSON_TEST_DOUBLE_FIELD.full_name = '.tutorial.Person.test_double'
module.PERSON_TEST_DOUBLE_FIELD.number = 7
module.PERSON_TEST_DOUBLE_FIELD.index = 6
module.PERSON_TEST_DOUBLE_FIELD.label = 3
module.PERSON_TEST_DOUBLE_FIELD.has_default_value = false
module.PERSON_TEST_DOUBLE_FIELD.default_value = {}
module.PERSON_TEST_DOUBLE_FIELD.type = 1
module.PERSON_TEST_DOUBLE_FIELD.cpp_type = 5

module.PERSON_LAST_UPDATED_FIELD.name = 'last_updated'
module.PERSON_LAST_UPDATED_FIELD.full_name = '.tutorial.Person.last_updated'
module.PERSON_LAST_UPDATED_FIELD.number = 8
module.PERSON_LAST_UPDATED_FIELD.index = 7
module.PERSON_LAST_UPDATED_FIELD.label = 1
module.PERSON_LAST_UPDATED_FIELD.has_default_value = false
module.PERSON_LAST_UPDATED_FIELD.default_value = nil
module.PERSON_LAST_UPDATED_FIELD.message_type = module.TIMESTAMP_PB_TIMESTAMP
module.PERSON_LAST_UPDATED_FIELD.type = 11
module.PERSON_LAST_UPDATED_FIELD.cpp_type = 10
...
module.PERSON.fields = {module.PERSON_NAME_FIELD, module.PERSON_ID_FIELD, module.PERSON_EMAIL_FIELD, module.PERSON_PHONES_FIELD, module.PERSON_TEST_UINT64_FIELD, module.PERSON_TEST_FLOAT_FIELD, module.PERSON_TEST_DOUBLE_FIELD, module.PERSON_LAST_UPDATED_FIELD}
